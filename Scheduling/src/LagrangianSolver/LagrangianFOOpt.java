...
public class LagrangianFOOpt {
	...
	public static int numIter = 500000, countIter = 0, lastIter = 0;
...
//				printParam();
			...
			cplex.clearModel();
			System.out.println("Iter " + countIter + ", bestUB " + bestUB + ",  " + currLB);
		}
	}
